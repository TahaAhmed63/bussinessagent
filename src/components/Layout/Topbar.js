                  ...
                  <ul className="buy-button list-inline mb-0">
                    ...
                    <li className="list-inline-item ps-1 mb-0">
                      <Link
                        ...
                        rel="noreferrer"
                      >
                        <div id="buyButton" className="btn btn-icon btn-pills btn-outline-primary shoppingbtn">
                          <FeatherIcon
                            icon="shopping-cart"
                            className="fea icon-sm"
                          />
                  ...
                  <ul className="buy-button list-inline mb-0">
                    ...
                    <li className="list-inline-item ps-1 mb-0">
                      <Link
                        ...
                        rel="noreferrer"
                      >
                        <div id="buyButton" className="btn btn-outline-primary shoppingbtn">
                          Login
                        </div>
                      </Link>
                    </li>
            ...
            <div id="navigation" style={{ display: this.state.isOpen ? 'block' : 'none' }}>
              ...
              <ul className="navigation-menu nav-dark" id="top-menu">
                ...
                <li className="has-submenu parent-parent-menu-item">
                  <Link to="#" onClick={() => this.setState({ landing: !this.state.landing })}>Form a US Company</Link><span className="menu-arrow"></span>
                  <ul className={classnames("submenu", { open: this.state.landing })}>
                    <li>
                      <ul>
                        ...
                        <li><Link to="/registeragent" className="sub-menu-item">  Registered Agent</Link></li>
                ...
                <li className="has-submenu parent-parent-menu-item">
                  <Link to="#" onClick={() => this.setState({ landing: !this.state.landing })}>US Banking</Link><span className="menu-arrow"></span>
                  <ul className={classnames("submenu", { open: this.state.landing })}>
                    <li>
                      <ul>
                        {/* <li className="megamenu-head"><i className="uil uil-book-open fs-6 align-middle"></i> Form a US Company</li> */}
                        <li><Link to="/index-saas" className="sub-menu-item"> Open a US Business Bank Account Remotly</Link></li>
                        {/* <li><Link to="/index-classic-saas" className="sub-menu-item">Open a US Business Personal Bank Account Remotly</Link></li>
                        <li><Link to="/index-agency" className="sub-menu-item">Open a US Business Bank Account without EIN or SSN</Link></li> */}
                      </ul>
                    </li>
                  </ul>
                </li>
                <li className="has-submenu parent-parent-menu-item">
                  <Link to="#" onClick={() => this.setState({ landing: !this.state.landing })}>Business Tools</Link><span className="menu-arrow"></span>
                  <ul className={classnames("submenu", { open: this.state.landing })}>
                    <li>
                      <ul>
                        {/* <li className="megamenu-head"><i className="uil uil-book-open fs-6 align-middle"></i> Form a US Company</li> */}
                        <li><Link to="/index-classic-saas" className="sub-menu-item"> Virtual Office</Link></li>
                        <li><Link to="/index-agency" className="sub-menu-item"> Mail Forwarding</Link></li>
                        <li><Link to="/index-agency" className="sub-menu-item">  Busniness Address</Link></li>
                        <li><Link to="/index-agency" className="sub-menu-item"> Phone Service</Link></li>
                        <li><Link to="/index-saas" className="sub-menu-item">Virtual Assistant</Link></li>
                      </ul>
                    </li>
                  </ul>
                </li>
                <li className="has-submenu parent-parent-menu-item">
                  <Link to="#" onClick={() => this.setState({ landing: !this.state.landing })}>Other Services</Link><span className="menu-arrow"></span>
                  <ul className={classnames("submenu", { open: this.state.landing })}>
                    <li>
                      <ul>
                        {/* <li className="megamenu-head"><i className="uil uil-book-open fs-6 align-middle"></i> Form a US Company</li> */}
                        <li><Link to="/index-saas" className="sub-menu-item">Import & Export Service</Link></li>
                        <li><Link to="/index-agency" className="sub-menu-item">Equipment Sourcing & Supplying</Link></li>
                        <li><Link to="/index-agency" className="sub-menu-item">Sell your products in the US</Link></li>
                        <li><Link to="/index-agency" className="sub-menu-item"> Buy the right equipment from the US</Link></li>
                        <li><Link to="/index-agency" className="sub-menu-item">Engineering Services</Link></li>
                      </ul>
                    </li>
                  </ul>
                </li>
                <li className="has-submenu parent-parent-menu-item">
                  <Link to="#" onClick={() => this.setState({ landing: !this.state.landing })}>Go Offshare</Link><span className="menu-arrow"></span>
                  <ul className={classnames("submenu", { open: this.state.landing })}>
                    <li>
                      <ul>
                        {/* <li className="megamenu-head"><i className="uil uil-book-open fs-6 align-middle"></i> Form a US Company</li> */}
                        <li><Link to="/index-saas" className="sub-menu-item">Form an offshare Company</Link></li>
                        <li><Link to="/index-agency" className="sub-menu-item">Open an offshare Bank account</Link></li>
                      </ul>
                    </li>
                  </ul>
                </li>
                {/* <li className="has-submenu parent-parent-menu-item">
                  <Link to="/page-aboutus-two" onClick={() => this.setState({ landing: !this.state.landing })}>About</Link>
                </li>
                <li className="has-submenu parent-parent-menu-item">
                  <Link to="/page-blog-grid" onClick={() => this.setState({ landing: !this.state.landing })}>Blog</Link>
                </li> */}
                </ul>
              {/* menu end */}
